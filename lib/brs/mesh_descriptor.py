...
def export_mesh_descriptor(input_file_path, output_file_path):
	...
	with open(input_file_path, 'rb') as f_brs:
		mesh_descriptor.class_name, mesh_descriptor.file_path = read_cat_file_start(f_brs)
		
		if(mesh_descriptor.class_name != "MeshDescriptor" and mesh_descriptor.class_name != "@MeshDescriptor"):
			return
